...
// not optimal, but anyway node will cache this: https://nodejs.org/api/modules.html#modules_require_cache
const zebra = () => require('./zebra')
const nippon = () => require('./nippon')
const cashino = () => require('./cashino')

const ZEBRA_MODEL = 'Zebra-KR-403'
const NIPPON_MODEL = 'Nippon-2511D-2'
const CASHINO_MODEL = 'Cashino-KP-210H'
...
function load () {
  return new Promise((resolve, reject) => {
    ...
    if (model === CASHINO_MODEL) return resolve(cashino())
